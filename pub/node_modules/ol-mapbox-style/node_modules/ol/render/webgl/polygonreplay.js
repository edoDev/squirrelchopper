  ...
  */
    ...
    for (i = 0, ii = polygons.length; i < ii; ++i) {
      ...
      if (linearRings.length > 0) {
        ...
        for (j = 1, jj = linearRings.length; j < jj; ++j) {
          ...
          holeFlatCoords = _ol_geom_flat_transform_.translate(holeFlatCoords, 0, holeFlatCoords.length,
              stride, -this.origin[0], -this.origin[1]);
  ...
  _ol_render_webgl_PolygonReplay_.prototype.setUpProgram = function(gl, context, size, pixelRatio) {
    ...
    if (!this.defaultLocations_) {
      locations =
          new _ol_render_webgl_polygonreplay_defaultshader_.Locations(gl, program);
