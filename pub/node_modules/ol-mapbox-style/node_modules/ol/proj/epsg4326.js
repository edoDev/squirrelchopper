 ...
 * @private
 */
_ol_proj_.EPSG4326_ = function(code, opt_axisOrientation) {
...
_ol_.inherits(_ol_proj_.EPSG4326_, _ol_proj_Projection_);
...
_ol_proj_EPSG4326_.PROJECTIONS = [
  new _ol_proj_.EPSG4326_('CRS:84'),
  new _ol_proj_.EPSG4326_('EPSG:4326', 'neu'),
  new _ol_proj_.EPSG4326_('urn:ogc:def:crs:EPSG::4326', 'neu'),
  new _ol_proj_.EPSG4326_('urn:ogc:def:crs:EPSG:6.6:4326', 'neu'),
  new _ol_proj_.EPSG4326_('urn:ogc:def:crs:OGC:1.3:CRS84'),
  new _ol_proj_.EPSG4326_('urn:ogc:def:crs:OGC:2:84'),
  new _ol_proj_.EPSG4326_('http://www.opengis.net/gml/srs/epsg.xml#4326', 'neu'),
  new _ol_proj_.EPSG4326_('urn:x-ogc:def:crs:EPSG:4326', 'neu')
];
