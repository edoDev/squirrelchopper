...
_ol_layer_VectorTile_.prototype.getPreload = function() {
  return /** @type {number} */ (this.get(_ol_layer_VectorTile_.Property_.PRELOAD));
};
...
_ol_layer_VectorTile_.prototype.getUseInterimTilesOnError = function() {
  return /** @type {boolean} */ (
      this.get(_ol_layer_VectorTile_.Property_.USE_INTERIM_TILES_ON_ERROR));
};
 ...
 * @private
 */
_ol_layer_VectorTile_.Property_ = {
  PRELOAD: 'preload',
