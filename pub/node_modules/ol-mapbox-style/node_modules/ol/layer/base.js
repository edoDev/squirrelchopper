...
_ol_layer_Base_.prototype.getOpacity = function() {
  return /** @type {number} */ (this.get(_ol_layer_Property_.OPACITY));
};
...
_ol_layer_Base_.prototype.getVisible = function() {
  return /** @type {boolean} */ (this.get(_ol_layer_Property_.VISIBLE));
};
...
_ol_layer_Base_.prototype.getZIndex = function() {
  return /** @type {number} */ (this.get(_ol_layer_Property_.Z_INDEX));
};
