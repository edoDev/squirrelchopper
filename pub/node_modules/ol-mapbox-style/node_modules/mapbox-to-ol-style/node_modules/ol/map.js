...
import _ol_proj_common_ from './proj/common';
...
var _ol_Map_ = function(options) {
   ...
   */
  this.mapBrowserEventHandler_ = new _ol_MapBrowserEventHandler_(this);
 ...
 * @api
 */
_ol_Map_.prototype.beforeRender = function(var_args) {
  this.render();
...
_ol_Map_.prototype.getLayerGroup = function() {
  return /** @type {ol.layer.Group} */ (this.get(_ol_MapProperty_.LAYERGROUP));
};
...
_ol_Map_.prototype.getSize = function() {
  return /** @type {ol.Size|undefined} */ (this.get(_ol_MapProperty_.SIZE));
};
...
_ol_Map_.prototype.getView = function() {
  return /** @type {ol.View} */ (this.get(_ol_MapProperty_.VIEW));
};
