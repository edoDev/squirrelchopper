  ...
  return (
      ...
      function(map, frameState) {
        if (frameState.time < start) {
          ...
          frameState.viewHints[_ol_ViewHint_.ANIMATING] += 1;
          return true;
 ...
 * @api
 */
_ol_animation_.pan = function(options) {
  ...
  var duration = options.duration !== undefined ? options.duration : 1000;
  var easing = options.easing ?
      options.easing : _ol_easing_.inAndOut;
  return (
      /**
       * @param {ol.Map} map Map.
       * @param {?olx.FrameState} frameState Frame state.
 ...
 * @api
 */
_ol_animation_.rotate = function(options) {
      ...
      function(map, frameState) {
        if (frameState.time < start) {
          ...
          if (anchor) {
            ...
            _ol_coordinate_.sub(center, anchor);
            _ol_coordinate_.rotate(center, deltaRotation);
 ...
 * @api
 */
_ol_animation_.zoom = function(options) {
