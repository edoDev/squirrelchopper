 ...
 * @inheritDoc
 */
_ol_style_RegularShape_.prototype.listenImageChange = _ol_.nullFunction;


/**
 * @inheritDoc
 */
_ol_style_RegularShape_.prototype.load = _ol_.nullFunction;


/**
 * @inheritDoc
 */
_ol_style_RegularShape_.prototype.unlistenImageChange = _ol_.nullFunction;
...
_ol_style_RegularShape_.prototype.render_ = function(atlasManager) {
  ...
  if (this.stroke_) {
    strokeStyle = _ol_colorlike_.asColorLike(this.stroke_.getColor());
...
_ol_style_RegularShape_.prototype.draw_ = function(renderOptions, context, x, y) {
  ...
  if (this.fill_) {
    context.fillStyle = _ol_colorlike_.asColorLike(this.fill_.getColor());
    context.fill();
  }
  if (this.stroke_) {
