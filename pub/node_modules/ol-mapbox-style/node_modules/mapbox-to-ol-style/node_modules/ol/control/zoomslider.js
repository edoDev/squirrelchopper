  ...
  if (!this.dragging_ &&
    ...
    if (this.dragListenerKeys_.length === 0) {
      ...
      this.dragListenerKeys_.push(
        _ol_events_.listen(document, _ol_events_EventType_.MOUSEMOVE, drag, this),
        _ol_events_.listen(document, _ol_events_EventType_.TOUCHMOVE, drag, this),
        _ol_events_.listen(document, _ol_pointer_EventType_.POINTERMOVE, drag, this),
        _ol_events_.listen(document, _ol_events_EventType_.MOUSEUP, end, this),
        _ol_events_.listen(document, _ol_events_EventType_.TOUCHEND, end, this),
        _ol_events_.listen(document, _ol_pointer_EventType_.POINTERUP, end, this)
      );
    }
  }
};
