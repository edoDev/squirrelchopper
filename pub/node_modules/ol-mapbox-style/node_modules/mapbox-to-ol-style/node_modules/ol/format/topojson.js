 ...
 * @private
 */
_ol_format_TopoJSON_.EXTENSIONS_ = ['.topojson'];
 ...
 * @inheritDoc
 */
_ol_format_TopoJSON_.prototype.getExtensions = function() {
  return _ol_format_TopoJSON_.EXTENSIONS_;
};
...
_ol_format_TopoJSON_.prototype.readFeaturesFromObject = function(
  ...
  if (object.type == 'Topology') {
    ...
    var features = [];
    var topoJSONFeatures = _ol_obj_.getValues(topoJSONTopology.objects);
    var i, ii;
    var feature;
 ...
 * @api stable
 */
_ol_format_TopoJSON_.prototype.readProjection = function(object) {
