...
var _ol_format_WFS_ = function(opt_options) {
  ...
  this.schemaLocation_ = options.schemaLocation ?
      options.schemaLocation : _ol_format_WFS_.SCHEMA_LOCATION;
 ...
 * @type {string}
 */
_ol_format_WFS_.SCHEMA_LOCATION = 'http://www.opengis.net/wfs ' +
...
_ol_format_WFS_.writeLogicalFilter_ = function(node, filter, objectStack) {
  ...
  _ol_xml_.pushSerializeAndPop(item,
      _ol_format_WFS_.GETFEATURE_SERIALIZERS_,
      _ol_xml_.makeSimpleNodeFactory(conditionA.getTagName()),
      [conditionA], objectStack);
  var conditionB = filter.conditionB;
  _ol_xml_.pushSerializeAndPop(item,
      _ol_format_WFS_.GETFEATURE_SERIALIZERS_,
      _ol_xml_.makeSimpleNodeFactory(conditionB.getTagName()),
