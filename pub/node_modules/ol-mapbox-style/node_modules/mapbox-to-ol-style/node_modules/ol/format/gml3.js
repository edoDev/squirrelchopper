 ...
 * @private
 */
_ol_format_GML3_.prototype.getCoords_ = function(point, opt_srsName) {
  var axisOrientation = 'enu';
  if (opt_srsName) {
...
_ol_format_GML3_.prototype.writeMultiSurfaceOrPolygon_ = function(node, geometry, objectStack) {
  ...
  _ol_xml_.pushSerializeAndPop({node: node, srsName: srsName, surface: surface},
...
_ol_format_GML3_.prototype.writeMultiPoint_ = function(node, geometry,
  ...
  _ol_xml_.pushSerializeAndPop({node: node, srsName: srsName},
...
_ol_format_GML3_.prototype.writeMultiCurveOrLineString_ = function(node, geometry, objectStack) {
  ...
  _ol_xml_.pushSerializeAndPop({node: node, srsName: srsName, curve: curve},
