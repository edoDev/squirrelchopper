 ...
 * @api
 */
_ol_format_filter_.and = function(conditionA, conditionB) {
  return new _ol_format_filter_And_(conditionA, conditionB);
};
 ...
 * @api
 */
_ol_format_filter_.or = function(conditionA, conditionB) {
  return new _ol_format_filter_Or_(conditionA, conditionB);
};
