...
import _ol_Constraints_ from './constraints';
...
var _ol_View_ = function(opt_options) {
   ...
   * @type {ol.Constraints}
   */
  this.constraints_ = new _ol_Constraints_(
 ...
 * @api stable
 */
_ol_View_.prototype.calculateExtent = function(size) {
...
_ol_View_.prototype.getRotation = function() {
  return /** @type {number} */ (this.get(_ol_ViewProperty_.ROTATION));
};
