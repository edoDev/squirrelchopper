...
var _ol_Geolocation_ = function(opt_options) {
  ...
  _ol_events_.listen(
      this, _ol_Object_.getChangeEventType(_ol_Geolocation_.Property_.PROJECTION),
      this.handleProjectionChanged_, this);
  _ol_events_.listen(
      this, _ol_Object_.getChangeEventType(_ol_Geolocation_.Property_.TRACKING),
      this.handleTrackingChanged_, this);

  if (options.projection !== undefined) {
    this.setProjection(_ol_proj_.get(options.projection));
  }
...
_ol_Geolocation_.prototype.handleProjectionChanged_ = function() {
  ...
  if (projection) {
    ...
    if (this.position_) {
      this.set(
          _ol_Geolocation_.Property_.POSITION, this.transform_(this.position_));
    }
  }
};
...
_ol_Geolocation_.prototype.positionChange_ = function(position) {
  ...
  this.set(_ol_Geolocation_.Property_.ACCURACY, coords.accuracy);
  this.set(_ol_Geolocation_.Property_.ALTITUDE,
      coords.altitude === null ? undefined : coords.altitude);
  this.set(_ol_Geolocation_.Property_.ALTITUDE_ACCURACY,
      coords.altitudeAccuracy === null ?
      undefined : coords.altitudeAccuracy);
  this.set(_ol_Geolocation_.Property_.HEADING, coords.heading === null ?
  ...
  this.set(_ol_Geolocation_.Property_.POSITION, projectedPosition);
  this.set(_ol_Geolocation_.Property_.SPEED,
      coords.speed === null ? undefined : coords.speed);
  var geometry = _ol_geom_Polygon_.circular(
      _ol_sphere_WGS84_, this.position_, coords.accuracy);
  geometry.applyTransform(this.transform_);
  this.set(_ol_Geolocation_.Property_.ACCURACY_GEOMETRY, geometry);
  this.changed();
};
...
_ol_Geolocation_.prototype.getAccuracy = function() {
  return /** @type {number|undefined} */ (
      this.get(_ol_Geolocation_.Property_.ACCURACY));
};
...
_ol_Geolocation_.prototype.getAccuracyGeometry = function() {
  return /** @type {?ol.geom.Geometry} */ (
      this.get(_ol_Geolocation_.Property_.ACCURACY_GEOMETRY) || null);
};
...
_ol_Geolocation_.prototype.getAltitude = function() {
  return /** @type {number|undefined} */ (
      this.get(_ol_Geolocation_.Property_.ALTITUDE));
};
...
_ol_Geolocation_.prototype.getAltitudeAccuracy = function() {
  return /** @type {number|undefined} */ (
      this.get(_ol_Geolocation_.Property_.ALTITUDE_ACCURACY));
};
...
_ol_Geolocation_.prototype.getHeading = function() {
  return /** @type {number|undefined} */ (
      this.get(_ol_Geolocation_.Property_.HEADING));
};
...
_ol_Geolocation_.prototype.getPosition = function() {
  return /** @type {ol.Coordinate|undefined} */ (
      this.get(_ol_Geolocation_.Property_.POSITION));
};
...
_ol_Geolocation_.prototype.getProjection = function() {
  return /** @type {ol.proj.Projection|undefined} */ (
      this.get(_ol_Geolocation_.Property_.PROJECTION));
};
...
_ol_Geolocation_.prototype.getSpeed = function() {
  return /** @type {number|undefined} */ (
      this.get(_ol_Geolocation_.Property_.SPEED));
};
...
_ol_Geolocation_.prototype.getTracking = function() {
  return /** @type {boolean} */ (
      this.get(_ol_Geolocation_.Property_.TRACKING));
};
...
_ol_Geolocation_.prototype.getTrackingOptions = function() {
  return /** @type {GeolocationPositionOptions|undefined} */ (
      this.get(_ol_Geolocation_.Property_.TRACKING_OPTIONS));
};
...
_ol_Geolocation_.prototype.setProjection = function(projection) {
  this.set(_ol_Geolocation_.Property_.PROJECTION, projection);
};
...
_ol_Geolocation_.prototype.setTracking = function(tracking) {
  this.set(_ol_Geolocation_.Property_.TRACKING, tracking);
};
...
_ol_Geolocation_.prototype.setTrackingOptions = function(options) {
  this.set(_ol_Geolocation_.Property_.TRACKING_OPTIONS, options);
};
