...
_ol_coordinate_.degreesToStringHDMS_ = function(degrees, hemispheres, opt_fractionDigits) {
  ...
  return Math.floor(x / 3600) + '\u00b0 ' +
      _ol_string_.padNumber(Math.floor((x / 60) % 60), 2) + '\u2032 ' +
      _ol_string_.padNumber((x % 60), 2, dflPrecision) + '\u2033 ' +
...
_ol_coordinate_.toStringHDMS = function(coordinate, opt_fractionDigits) {
  if (coordinate) {
    return _ol_coordinate_.degreesToStringHDMS_(coordinate[1], 'NS', opt_fractionDigits) + ' ' +
        _ol_coordinate_.degreesToStringHDMS_(coordinate[0], 'EW', opt_fractionDigits);
  } else {
    return '';
  }
};
