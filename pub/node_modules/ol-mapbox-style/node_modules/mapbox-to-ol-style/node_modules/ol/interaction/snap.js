...
_ol_interaction_Snap_.prototype.addFeature = function(feature, opt_listen) {
  ...
  if (geometry) {
    ...
    if (segmentWriter) {
      ...
      if (listen) {
        this.geometryModifyListenerKeys_[feature_uid] = _ol_events_.listen(
            geometry,
  ...
  if (listen) {
    this.geometryChangeListenerKeys_[feature_uid] = _ol_events_.listen(
        feature,
        _ol_Object_.getChangeEventType(feature.getGeometryName()),
 ...
 * @private
 */
_ol_interaction_Snap_.prototype.handleGeometryChange_ = function(evt) {
 ...
 * @private
 */
_ol_interaction_Snap_.prototype.handleGeometryModify_ = function(feature, evt) {
...
_ol_interaction_Snap_.prototype.removeFeature = function(feature, opt_unlisten) {
  ...
  if (extent) {
    ...
    if (unlisten) {
      _ol_Observable_.unByKey(this.geometryModifyListenerKeys_[feature_uid]);
      delete this.geometryModifyListenerKeys_[feature_uid];
    }
  }

  if (unlisten) {
    _ol_Observable_.unByKey(this.geometryChangeListenerKeys_[feature_uid]);
...
_ol_interaction_Snap_.prototype.setMap = function(map) {
  ...
  if (currentMap) {
    keys.forEach(_ol_Observable_.unByKey);
    keys.length = 0;
  ...
  if (segments.length > 0) {
    ...
    if (this.vertex_ && !this.edge_) {
      ...
      vertex = (_ol_coordinate_.closestOnSegment(pixelCoordinate,
          closestSegment));
      vertexPixel = map.getPixelFromCoordinate(vertex);
      if (Math.sqrt(_ol_coordinate_.squaredDistance(pixel, vertexPixel)) <=
