...
_ol_interaction_Modify_.prototype.willModifyFeatures_ = function(evt) {
  if (!this.modified_) {
    ...
    this.dispatchEvent(new _ol_interaction_Modify_.Event(
        _ol_interaction_Modify_.EventType_.MODIFYSTART, this.features_, evt));
  }
};
...
_ol_interaction_Modify_.handleDownEvent_ = function(evt) {
  ...
  if (vertexFeature) {
    ...
    for (var i = 0, ii = segmentDataMatches.length; i < ii; ++i) {
      ...
      if (_ol_coordinate_.equals(segment[0], vertex) &&
      ...
      } else if (_ol_.getUid(segment) in this.vertexSegments_ &&
...
_ol_interaction_Modify_.handleUpEvent_ = function(evt) {
  ...
  if (this.modified_) {
    this.dispatchEvent(new _ol_interaction_Modify_.Event(
        _ol_interaction_Modify_.EventType_.MODIFYEND, this.features_, evt));
    this.modified_ = false;
  }
  return false;
};
...
_ol_interaction_Modify_.prototype.handlePointerAtPixel_ = function(pixel, map) {
  ...
  var sortByDistance = function(a, b) {
    return _ol_coordinate_.squaredDistanceToSegment(pixelCoordinate, a.segment) -
        _ol_coordinate_.squaredDistanceToSegment(pixelCoordinate, b.segment);
  };
 ...
 * @private
 */
_ol_interaction_Modify_.EventType_ = {
  /**
