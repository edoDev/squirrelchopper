...
_ol_interaction_DragRotateAndZoom_.handleDragEvent_ = function(mapBrowserEvent) {
  ...
  if (this.lastMagnitude_ !== undefined) {
    ...
    _ol_interaction_Interaction_.zoomWithoutConstraints(map, view, resolution);
  }
  if (this.lastMagnitude_ !== undefined) {
...
_ol_interaction_DragRotateAndZoom_.handleUpEvent_ = function(mapBrowserEvent) {
  ...
  _ol_interaction_Interaction_.rotate(map, view, view.getRotation());
  _ol_interaction_Interaction_.zoom(map, view, view.getResolution(),
