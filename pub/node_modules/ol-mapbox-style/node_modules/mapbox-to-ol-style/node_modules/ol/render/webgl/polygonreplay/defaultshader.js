...
if (false) {
   ...
   * @type {string}
   */
  _ol_render_webgl_polygonreplay_defaultshader_.Fragment.SOURCE = _ol_render_webgl_polygonreplay_defaultshader_.Fragment.OPTIMIZED_SOURCE;
   ...
   * @type {string}
   */
  _ol_render_webgl_polygonreplay_defaultshader_.Vertex.SOURCE = _ol_render_webgl_polygonreplay_defaultshader_.Vertex.OPTIMIZED_SOURCE;
