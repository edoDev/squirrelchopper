...
_ol_DeviceOrientation_.prototype.getAlpha = function() {
  return /** @type {number|undefined} */ (
      this.get(_ol_DeviceOrientation_.Property_.ALPHA));
};
...
_ol_DeviceOrientation_.prototype.getBeta = function() {
  return /** @type {number|undefined} */ (
      this.get(_ol_DeviceOrientation_.Property_.BETA));
};
...
_ol_DeviceOrientation_.prototype.getGamma = function() {
  return /** @type {number|undefined} */ (
      this.get(_ol_DeviceOrientation_.Property_.GAMMA));
};
...
_ol_DeviceOrientation_.prototype.getHeading = function() {
  return /** @type {number|undefined} */ (
      this.get(_ol_DeviceOrientation_.Property_.HEADING));
};
...
_ol_DeviceOrientation_.prototype.getTracking = function() {
  return /** @type {boolean} */ (
      this.get(_ol_DeviceOrientation_.Property_.TRACKING));
};
